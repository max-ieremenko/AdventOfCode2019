...
namespace Day11
{
    internal sealed class IntCodeComputer
    {
        ...
        public Action<int, int> OnOutput { get; set; }
        ...
        public void Run()
        {
            ...
            while (true)
            {
                switch (Stack.GetOpCode())
                {
                    ...
                    {
                        var input = OnInput();
                        InputInstruction(relativeBase, input);
                    }
                        break;

                    case 4:
                    {
                        var value2 = Output(relativeBase);
                        ...
                        {
                            var value1 = lastOutput.Value;
                            lastOutput = null;
                            OnOutput((int) value1, (int) value2);
                        }
                    }
                        break;
