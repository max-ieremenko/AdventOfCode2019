...
namespace Day12
{
    ...
    public class Task2Test
    {
        ...
        public static void Solve(IEnumerable<string> input, long expected)
        {
...
<x=9, y=-8, z=-3>";
            ...
            yield return new TestCaseData(Input2.Split(new[] { '\r', '\n' }, StringSplitOptions.RemoveEmptyEntries), 4686774924)
            {
                TestName = "case 2"
            };
        }
