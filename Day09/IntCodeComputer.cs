...
namespace Day09
{
    internal sealed class IntCodeComputer
    {
        ...
        public long Run(long[] memory, int inputInstruction)
        {
            var inputInstructionIndex = 0;
            ...
            while (true)
            {
                switch (Stack.GetOpCode())
                {
                    ...
                    case 3:
                        ...
                        InputInstruction(relativeBase, inputInstruction);
                        break;

                    case 4:
                        Output(relativeBase, ref output);
                        return output;
        ...
        private void Output(long relativeBase, ref long value)
        {
            value = Stack.GetParameter1Value(relativeBase);
            Stack.Shift(1);
        }
